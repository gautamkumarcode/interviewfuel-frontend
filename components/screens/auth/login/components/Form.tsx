		...
		<div className="relative w-full max-w-md mx-auto">
			<div className="relative">
				...
				<div className="text-center mb-4">
					...
					<h1 className="text-3xl font-bold bg-gradient-to-r from-gray-700 to-green-800 bg-clip-text text-transparent mb-2">
						Welcome Back
					</h1>
					...
					<form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
										...
										<div className="relative group">
											...
											<div className="relative">
												...
												<Input
													...
													type="email"
													className="pl-12 pr-4 py-3 bg-gray-50/50 border-2 border-gray-200 focus:border-blue-500 focus:bg-white transition-all duration-300 rounded-md focus:ring-0 h-12"
													{...field}
												/>
											</div>
										</div>
										...
										<div className="relative group">
											...
											<div className="relative">
												...
												<Input
													...
													className="pl-12 pr-12 h-12 py-3 bg-gray-50/50 border-2 border-gray-200 rounded-md focus:border-purple-500 focus:bg-white transition-all duration-300 hover:border-gray-300"
													{...field}
												/>
												<button
													type="button"
						...
						<div className="pt-2">
							<CustomButton
								content="Sign In"
								isLoading={isLoading}
								className="w-full py-3 bg-gradient-to-r from-emerald-600 to-green-600 hover:from-emerald-700 hover:to-blue-700  text-white font-semibold rounded-md shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-300"
							/>
						</div>
					</form>
				</Form>
