    ...
    <div className="space-y-8">
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold">Companies (Optional)</h3>
          <Button
            type="button"
            onClick={() => {
        ...
        <div className="space-y-4">
          {companyFields.map((field, index) => (
            <Card key={field.id} className="p-4 border-2 border-gray-200 shadow-sm">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      ...
                      <FormDescription>The name of the company that asks this question.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="w-24">
                      ...
                      <FormDescription>How often this company asks this question.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
      ...
      <div>
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold">Hints (Optional)</h3>
          <Button
            type="button"
            onClick={() => {
            ...
            <Card key={field.id} className="p-4 border-2 border-gray-200 shadow-sm">
              <div className="flex gap-4 items-start">
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex-1">
                      <FormLabel className="font-bold">Hint Content</FormLabel>
                      <FormControl>
                        <Textarea 
                      ...
                      <FormDescription>A guiding clue to help users approach or solve the question.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
