				...
				<Card>
					<CardContent className="p-4 text-center">
						<div className="text-2xl font-bold text-green-600 mb-1">
							{userData.stats.practiceHours}h
						</div>
							...
							<CardContent className="space-y-4">
								...
								<div>
									<div className="flex justify-between text-sm mb-2">
										...
										<span className="font-medium">
											{userData.stats.averageTime} min
										</span>
									</div>
					...
					<Card>
						<CardHeader>
							<CardTitle className="flex items-center gap-2">
								...
								Favorite Category: {userData.stats.favoriteCategory}
							</CardTitle>
						</CardHeader>
						<CardContent>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								...
								<div className="flex items-center justify-between">
									...
									<Switch checked={userData.preferences.pushNotifications} />
								</div>
								...
								<div className="flex items-center justify-between">
									...
									<Switch checked={userData.preferences.weeklyDigest} />
								</div>
								...
								<div className="flex items-center justify-between">
									...
									<Switch checked={userData.preferences.practiceReminders} />
								</div>
							</CardContent>
						</Card>
						...
						<Card>
							...
							<CardContent className="space-y-4">
								<div className="flex items-center justify-between">
									...
									<Switch checked={userData.preferences.publicProfile} />
								</div>
								...
								<div className="flex items-center justify-between">
									...
									<Switch checked={userData.preferences.showStats} />
								</div>
