                                    ...
                                    >
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {open && <span className="text-sm font-medium">Frontend</span>}
                                            </div>
                                            {open && (
                                                    ...
                                                    link={{
                                                        ...
                                                        icon: (
                                                            <div className="flex items-center justify-between w-full">
                                                                ...
                                                                <Badge variant="secondary" className="text-[9px] px-1 py-0.5 bg-gray-100 dark:bg-gray-800">
                                                                    {item.count}
                                                                </Badge>
                                                            </div>
                                                        ),
                                    ...
                                    >
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {open && <span className="text-sm font-medium">Backend</span>}
                                            </div>
                                            {open && (
                                    ...
                                    >
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {open && <span className="text-sm font-medium">Mobile</span>}
                                            </div>
                                            {open && (
                                    ...
                                    >
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {open && <span className="text-sm font-medium">Data Science</span>}
                                            </div>
                                            {open && (
                                    ...
                                    >
                                        <div className="flex items-center justify-between w-full">
                                            <div className="flex items-center gap-2">
                                                ...
                                                {open && <span className="text-sm font-medium">System Design</span>}
                                            </div>
                                            {open && (
                                        ...
                                        <div className="flex items-center gap-2 w-full">
                                            ...
                                            {open && (
                                                <div className="flex flex-col">
                                                    <span className="text-xs font-medium text-gray-900 dark:text-gray-100">Abhishek Singh</span>
                                                    <span className="text-[10px] text-gray-500 dark:text-gray-400">Premium User</span>
                                                </div>
                                            )}
                                        </div>
                                    ),
...
export const LogoIcon = ({open}:any) => {
    return (
        <a
            href="/dashboard"
            className="relative z-20 flex items-center space-x-2 py-1 text-sm font-normal text-black"
        >
            <div className="h-5 w-6 shrink-0 rounded-tl-lg rounded-tr-sm rounded-br-lg rounded-bl-sm bg-green-500 dark:bg-white" />
            {open &&(
               <h1 className="font-bold text-lg"> InterView Fuel</h1>
            )}
        </a>
    );
};
