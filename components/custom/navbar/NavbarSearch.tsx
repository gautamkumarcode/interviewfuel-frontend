		...
		<div className="relative w-full max-w-md" ref={searchRef}>
			<form onSubmit={handleFullSearch} className="relative">
				...
				<Input
					...
					className="w-full h-10 pl-9 pr-9 text-sm bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-gray-300 focus:border-blue-500 focus:ring-1 focus:ring-blue-100 transition-all rounded-lg"
				/>
				{searchQuery && (
					<button
						type="button"
