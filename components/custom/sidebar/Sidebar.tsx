...
// 			{ name: "Angular", count: 134, icon: Settings, color: "text-red-500", href: "/questions/category/angular" },
...
// 		icon: Database,
// 		items: [
// 			{ name: "Node.js", count: 198, icon: Settings, color: "text-green-600", href: "/questions/category/nodejs" },
...
// 												className={cn(
// 													"h-auto p-3 flex flex-col items-center gap-1 border-gray-200 hover:border-gray-300 cursor-pointer",
// 													action.color
// 												)}>
...
// 													isMobile && "h-12 text-base active:bg-gray-200  cursor-pointer"
// 												)}>
// 												<div className="flex items-center gap-3">
// 													<item.icon className={cn("h-4 w-4", item.color, isMobile && "h-5 w-5")} />
